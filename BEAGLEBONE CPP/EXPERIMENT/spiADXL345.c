...
int main(){
   ...
   send[0]= (0x00+0x2D);  //want to read address 0x00 on the ADXL345
   send[1]= 0x08;  
   ...
   while(1){
	...
	send[0]= (0x80+0x32);
   	...
   	printf("Return value of X-Axis Data 0: 0x%.2x\n",receive[1]);
	...
	if (ioctl(file, SPI_IOC_MESSAGE(1), &transfer)<0){
        ...
        printf("Return value of X-Axis Data 1: 0x%.2x\n",receive[1]);
	  ...
	  send[0]= (0x80+0x34);
        ...
        printf("Return value of Y-Axis Data 0: 0x%.2x\n",receive[1]);
	...
	send[0]= (0x80+0x35);
        ...
        printf("Return value of Y-Axis Data 1: 0x%.2x\n",receive[1]);
	...
	send[0]= (0x80+0x36);
        ...
        printf("Return value of Z-Axis Data 0: 0x%.2x\n",receive[1]);
	...
	send[0]= (0x80+0x37);
        ...
        printf("Return value of Z-Axis Data 1: 0x%.2x\n",receive[1]);
